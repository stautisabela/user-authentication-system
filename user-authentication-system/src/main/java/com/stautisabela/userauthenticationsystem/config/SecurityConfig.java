package com.stautisabela.userauthenticationsystem.config;
...
import com.stautisabela.userauthenticationsystem.security.JwtConfigurer;
...
public class SecurityConfig {
	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		return http.httpBasic().disable()
				...
				.authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests.requestMatchers("/auth/signin",
																									"/auth/refresh/**",
																									"/swagger-ui/**",
																									"/v3/api-docs/**"
																									).permitAll()
